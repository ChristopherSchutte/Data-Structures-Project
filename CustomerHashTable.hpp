...
class CustomerHashTable
{
  public:
    ...
    void addPurchase(std::string custEmail, std::string productName, std::string catagory, std::string color, std::string date_purchased); //IMPORTANT ADD COLOR PARAMETER
